      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            handle: { crumb: () => 'Modules' },
            lazy: async () => {
              const { ProjectModulesListPage } =
                await import('../features/project-modules/ProjectModulesListPage');
              return { Component: ProjectModulesListPage };
            },
          },
          {
            path: 'features',
            handle: { crumb: () => 'Features' },
            lazy: async () => {
              const { FeaturesListPage } = await import('../features/features/FeaturesListPage');
          ...
          {
            path: 'sprints',
            handle: { crumb: () => 'Sprints' },
            lazy: async () => {
              const { SprintsListPage } = await import('../features/sprints/SprintsListPage');
